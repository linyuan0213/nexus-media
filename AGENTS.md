...
- **前端**: 独立仓库 [nexus-media-web](https://github.com/linyuan0213/nexus-media-web)，Vue 3 + Vite + Naive UI
...
## 前端 (web/frontend/apps/nexus-media/)
...
- 覆盖率: `uv run pytest tests/ -v --cov=app --cov-report=term-missing`

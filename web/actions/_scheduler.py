...
class WebActionSchedulerMixin:
    ...
    def _get_scheduler_jobs(data):
        ...
        if not scheduler:
            return WebActionBase._fail(msg="调度器未启动")
        ...
        return WebActionBase._success(data=job_list)
    ...
    def _update_scheduler_job(data):
        ...
        job_id = data.get("id")
        if not job_id:
            return WebActionBase._fail(msg="任务ID不能为空")
        ...
        if not job:
            return WebActionBase._fail(msg="任务不存在")
    ...
    def _delete_scheduler_job(data):
        ...
        if success:
            return WebActionBase._success(msg="删除成功")
        return WebActionBase._fail(msg="删除失败")
    ...
    def _pause_scheduler_job(data):
        ...
        if success:
            return WebActionBase._success(msg="暂停成功")
        return WebActionBase._fail(msg="暂停失败")
    ...
    def _resume_scheduler_job(data):
        ...
        return WebActionBase._fail(msg="恢复失败")
    ...
    def _run_scheduler_job(data):
        ...
        try:
            ...
            return WebActionBase._success(msg="任务已触发")
        except Exception as e:
